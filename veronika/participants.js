...
function createInputFields(container, rowId, placeholders, options = []) {
    const parameters = [
        { label: 'Техника', column: 'C', options: 10, placeholder: placeholders['costum'] },
        { label: 'Образ', column: 'D', options: 10, placeholder: placeholders['shozhest'] },
        { label: 'Артистичность', column: 'E', options: 10, placeholder: placeholders['vistup'] },
        { label: 'Впечатление', column: 'F', options: 10, placeholder: placeholders['aks'] }
    ];
