...
const sheet_Name = 'veronika'; //Основная страница с выставлением оценок жюри
const ResultSheet = 'veronikaRes'; // страница с итогами конкретного жюри

// Диапазоны для секций с участниками для аккардеона
    const section1Range = [2, 6];
    const section2Range = [7, 20];
    const section3Range = [21, 23];

//Диапазоны для таблицы с результатами в личных итогах каждого жюри
const RANGE_PARTS = [
    'A1:H26' // Диапазон для первой части    
];
