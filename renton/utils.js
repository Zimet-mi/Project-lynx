...
const sheet_Name = 'renton'; //Основная страница с выставлением оценок жюри
const ResultSheet = 'rentonRes'; // страница с итогами конкретного жюри

// Диапазоны для секций с участниками для аккардеона
    const section1Range = [2, 41];
    const section2Range = [42, 77];
    const section3Range = [78, 107];

//Диапазоны для таблицы с результатами в личных итогах каждого жюри
const RANGE_PARTS = [
    'A1:H79', // Диапазон для первой части
    'A81:H126', // Диапазон для второй части
    'A128:H135', // Диапазон для третьей части
